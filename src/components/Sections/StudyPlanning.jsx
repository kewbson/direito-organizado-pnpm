      ...
      <div className="grid grid-cols-2 sm:grid-cols-3 md:grid-cols-5 gap-2 md:gap-4">
        <Card className="hover:shadow-md transition-all duration-200 border-l-4 border-l-blue-300 bg-gradient-blue-400 from-blue-50 to-blue-100 dark:from-blue-950/20 dark:to-blue-900/20">
          <CardContent className="p-2 md:p-4 text-center">
            <div className="text-lg md:text-2xl font-bold text-primary dark:text-primary/90">{stats.total}</div>
            <div className="text-xs md:text-sm text-muted-foreground">Total</div>
          </CardContent>
        </Card>
        <Card className="over:shadow-md transition-all duration-200 border-l-4 border-l-green-300 bg-gradient-green-300 from-green-50 to-green-100 dark:from-green-950/20 dark:to-green-900/20">
          <CardContent className="p-2 md:p-4 text-center">
        ...
        <Card className="hover:shadow-md transition-all duration-200 border-l-4 border-l-yellow-300 bg-gradient-yellow-300 from-yellow-50 to-yellow-100 dark:from-yellow-950/20 dark:to-yellow-900/20">
          <CardContent className="p-2 md:p-4 text-center">
        ...
        <Card className="hover:shadow-md transition-all duration-200 border-l-4 border-l-purple-300 bg-gradient-purple-300 from-purple-50 to-purple-100 dark:from-purple-950/20 dark:to-purple-900/20">
          <CardContent className="p-2 md:p-4 text-center">
            <div className="text-lg md:text-2xl font-bold text-purple-600 dark:text-purple-500">{stats.pendentes}</div>
            <div className="text-xs md:text-sm text-muted-foreground">Pendentes</div>
          </CardContent>
        </Card>
        <Card className="hover:shadow-md transition-all duration-200 border-l-4 border-l-red-400 bg-gradient-red-300 from-red-50 to-red-100 dark:from-red-950/20 dark:to-red-900/20">
          <CardContent className="p-2 md:p-4 text-center">
            <div className="text-lg md:text-2xl font-bold text-red-600 dark:text-red-600">{stats.atrasados}</div>
