  ...
  return (
    <div className="min-h-screen">
      <div className="space-y-8 animate-slide-up">
        ...
        <Card className="hover:shadow-md transition-all duration-200 border-l-4 border-l-orange-300 bg-gradient-orange-300 from-orange-50 to-orange-100 dark:from-orange-950/20 dark:to-orange-900/20">
          ...
          <CardContent className="text-center ">
            <Dialog open={showConfigModal} onOpenChange={setShowConfigModal}>
              ...
              <DialogContent className="max-w-lg hover:shadow-md transition-all duration-200 border-l-4 border-l-green-300">
                <DialogHeader>
                ...
                <div className="space-y-6">
                  ...
                  <div className="space-y-3">
                    <label className="text-sm font-medium flex items-center gap-2">
                      ...
                      Selecione seu Período(em desenvolvimento)
                    </label>
        ...
        {/* Estatísticas Gerais */}
        <div className="grid grid-cols-2 md:grid-cols-4 gap-4">
          <GradientCard className="text-center p-6 hover-lift hover:shadow-md transition-all duration-200 border-l-4 border-l-orange-300 bg-gradient-orange-300 from-orange-50 to-orange-100 dark:from-orange-950/20 dark:to-orange-900/20">
          ...
          <GradientCard className="text-center p-6 hover-lift over:shadow-md transition-all duration-200 border-l-4 border-l-green-300 bg-gradient-green-300 from-green-50 to-green-100 dark:from-green-950/20 dark:to-green-900/20">
          ...
          <GradientCard className="text-center p-6 hover-lift hover:shadow-md transition-all duration-200 border-l-4 border-l-blue-300 bg-gradient-blue-400 from-blue-50 to-blue-100 dark:from-blue-950/20 dark:to-blue-900/20">
          ...
          <GradientCard className="text-center p-6 hover-lift hover:shadow-md transition-all duration-200 border-l-4 border-l-purple-300 bg-gradient-purple-300 from-purple-50 to-purple-100 dark:from-purple-950/20 dark:to-purple-900/20">
            ...
            <CardContent>
              <div className="space-y-3">
                {getRecentResults().map((result, index) => (
                  <GradientCard key={index} variant="default" className="p-4 hover-lift hover:shadow-md transition-all duration-200 border-l-4 border-l-blue-300 bg-gradient-blue-400 from-blue-50 to-blue-100 dark:from-blue-950/20 dark:to-blue-900/20">
                    <div className="flex items-center justify-between">
