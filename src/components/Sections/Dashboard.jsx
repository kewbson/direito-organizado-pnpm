...
import { PieChart as RechartsPieChart, Cell, Tooltip, ResponsiveContainer, Pie } from 'recharts'
...
export function Dashboard({ onSectionChange }) {
  ...
  return (
    <div className="space-y-6">
      ...
      <Card className="hover:shadow-md transition-all duration-200 border-l-4 border-l-orange-400 bg-gradient-orange-400 from-orange-50 to-orange-100 dark:from-orange-950/20 dark:to-orange-900/20">
        <CardHeader>
      ...
      <Tabs value={activeTab} onValueChange={setActiveTab} className="space-y-6">
        ...
        <TabsContent value="overview" className="space-y-6">
          ...
          <div className="grid grid-cols-2 md:grid-cols-4 gap-4">
            <Card className="hover:shadow-md transition-all duration-200 border-l-4 border-l-blue-300 bg-gradient-blue-400 from-blue-50 to-blue-100 dark:from-blue-950/20 dark:to-blue-900/20">
              <CardHeader className="flex flex-row items-center justify-between space-y-0 pb-2">
                <CardTitle className="text-sm font-medium">Próximos Eventos</CardTitle>
                <Calendar className="h-4 w-4 text-blue-400 dark:text-blue-400" />
              </CardHeader>
              <CardContent>
            ...
            <Card className="hover:shadow-md transition-all duration-200 border-l-4 border-l-green-300 bg-gradient-green-300 from-green-50 to-green-100 dark:from-green-950/20 dark:to-green-900/20">
              <CardHeader className="flex flex-row items-center justify-between space-y-0 pb-2">
            ...
            <Card className="hover:shadow-md transition-all duration-200 border-l-4 border-l-purple-300 bg-gradient-purple-300 from-purple-50 to-purple-100 dark:from-purple-950/20 dark:to-purple-900/20">
              <CardHeader className="flex flex-row items-center justify-between space-y-0 pb-2">
          ...
          <Card className="hover:shadow-md transition-all duration-200 border-l-4 border-l-blue-300 bg-gradient-blue-400 from-blue-50 to-blue-100 dark:from-blue-950/20 dark:to-blue-900/20">
            <CardHeader>
              <CardTitle className="flex items-center text-primary dark:primary/90">
                <Star className="h-5 w-5 mr-2" />
                Versículo do Dia
              </CardTitle>
            </CardHeader>
            <CardContent>
              <blockquote className="text-primary dark:primary/90 italic text-lg text-center font-medium leading-relaxed">
                "{currentQuote}"
              </blockquote>
              <div className="flex justify-center mt-4">
                <Button 
                  ...
                  className="text-primary dark:text-primary/90 border-blue-300 dark:border-blue-300 hover:bg-primary/90 dark:hover:bg-primary"
                >
                  Novo Versículo
                </Button>
              </div>
      ...
      <Card className="hover:shadow-md transition-all duration-200 border-l-4 border-l-blue-300 bg-gradient-blue-400 from-blue-50 to-blue-100 dark:from-blue-950/20 dark:to-blue-900/20">
        <CardHeader>
          <div className="flex items-center justify-between">
            <div>
              <CardTitle className="flex items-center text-blue-700 dark:text-blue-400 gap-2">
